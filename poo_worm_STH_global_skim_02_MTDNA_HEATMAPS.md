...
#FOR THE PAPER - 18 oCT 2023
#COMMENT IT OUT SO IT DOES NOT INTERFERE WITH THE CODE
#TO find how many non zero positives are there in the heatmaps!!!!
#REMEMBER TO COMMENTS THIS OUT WHEN YOU RUN THE CODE. I ONLY NEEDED IT FOR THE STATS
#ch2_df_w_clean_l_2_w$species_pos_counts_2 <-  rowSums(ch2_df_w_clean_l_2_w[,-1] !=0)

#STATS2 <-  ch2_df_w_clean_l_2_w %>%
# select(species_pos_counts_2, everything())
#
...
```{r heatmap, fig.height=14, fig.width=10, dpi=300}
# Use the column_split argument with the modified country column
hmap2 <- Heatmap(
