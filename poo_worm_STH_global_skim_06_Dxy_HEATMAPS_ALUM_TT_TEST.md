...
``` {r ALUM_ALL_DXY_POOLS, fig.path='./00_FIGURES/'}

png(filename = "00_FIGURES/ALUM_ALL_DXY_POOLS.png", height = 5, width = 8, units = "in", res = 300)
...
```
![ALUM_ALL_DXY_POOLS.png](00_FIGURE/ALUM_ALL_DXY_POOLS.png)
